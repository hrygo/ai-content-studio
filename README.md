...
如果你正在使用 AI 编程助手（如 Claude Code / OpenCode），只需将 [`INSTALL.md`](https://github.com/hrygo/voiceforge/blob/main/INSTALL.md) 发送给它，让它自行阅读并完成所有安装和 API 配置：
...
- [`INSTALL.md`](https://github.com/hrygo/voiceforge/blob/main/INSTALL.md) — AI Agent 安装说明
